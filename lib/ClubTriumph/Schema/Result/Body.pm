use utf8;
package ClubTriumph::Schema::Result::Body;
...
=head1 TABLE: C<bodies>

=cut

__PACKAGE__->table("bodies");
...
__PACKAGE__->has_many(
  ...
  { "foreign.body" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07033 @ 2013-11-24 20:11:19
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WAlxpYHYKJo/TYBBBsb7vA
